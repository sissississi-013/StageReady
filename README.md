...
| Service | Purpose |
|---------|---------|
| [Google Gemini API](https://ai.google.dev/) | Audio understanding for generating contextual comments and summaries |
| [ElevenLabs Conversational AI](https://elevenlabs.io/conversational-ai) | Voice-based AI co-host with natural conversation |
| [DiceBear Avatars](https://www.dicebear.com/) | Generated avatars for co-host profiles |
